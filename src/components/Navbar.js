        ...
        <nav css={navStyles}>
            <div className="container">
                <div className="title-section">
                    <NavLink className="title-link" to="/" onClick={hideDrawer}>Profile Site</NavLink>
                    <Hamburger isDrawerVisible={isDrawerVisible} setIsDrawerVisible={setIsDrawerVisible} />
                </div>
                <div className="drawer">
                    { isLoggedIn ? (
                        <div className="links-section">
                            <NavLink to="/" activeClassName="active-navlink" onClick={hideDrawer}>Create</NavLink>
                            <NavLink to="/" activeClassName="active-navlink" onClick={hideDrawer}>Profile</NavLink>
                        </div>
                    ) : (
                        <div className="links-section">
                            <NavLink to="/" activeClassName="active-navlink" onClick={hideDrawer}>Signup</NavLink>
                        </div>
                    )}
                </div>
            </div>
